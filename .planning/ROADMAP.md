...
- [x] 01-02-PLAN.md — docker-compose a .env + fix indentación de web, migrar seed a 4 roles con bcrypt
- [x] 01-03-PLAN.md — Implementar cliente HTTP centralizado services/api.ts
